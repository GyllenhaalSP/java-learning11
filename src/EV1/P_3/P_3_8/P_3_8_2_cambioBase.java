...
//    vez realizada la primera nos saldrá un mensaje indicando si queremos continuar.
    public static void main(String[] args) {
        ...
        do{
            ...
            switch (base) {
                case 2:
                    System.out.println("El número en binario es " + base(numero, base) + ".");
                    break;
                case 5:
                    System.out.println("El número en base 5 es " + base(numero, base) + ".");
                    break;
                case 8:
                    System.out.println("El número en octal es " + base(numero, base) + ".");
                    break;
                case 16:
                    System.out.println("El número en hexadecimal es " + base(numero, base) + ".");
                    break;
                default:
